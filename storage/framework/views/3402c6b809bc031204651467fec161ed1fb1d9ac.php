...
<div class="main-content-container container-fluid px-4">
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
      <div class="card card-small card-post card-post--1">
        <div class="card-post__image" style="background-image: url('<?php echo e(asset('dashboardassets/images/content-management/3.jpg')); ?>');border-radius: 10px">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Charity/resources/views/dashboard/admin.blade.php ENDPATH**/ ?>