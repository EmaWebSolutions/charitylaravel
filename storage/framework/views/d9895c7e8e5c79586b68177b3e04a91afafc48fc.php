          ...
          <div class='card-body p-0'>
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex px-3">
                   <a href="<?php echo e(url('dashboard/dashboardCategores')); ?>" class="btn btn-sm btn-outline-accent"><i class="icon-line-awesome-align-justify"></i> Categores</a>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Charity/resources/views/dashboard/dashboardCategores/edit.blade.php ENDPATH**/ ?>