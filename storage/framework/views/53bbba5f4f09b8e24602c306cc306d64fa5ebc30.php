...
<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
    ...
    <div class="nav-wrapper">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link<?php echo e(Request::is('dashboard/dashboardUsers') ? ' active' : ''); ?>" href="<?php echo e(url('dashboard/dashboardUsers')); ?>">
                    <i class="fas fa-user"></i>
                    <span>Users</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link<?php echo e(Request::is('dashboard/dashboardRoles') ? ' active' : ''); ?>" href="<?php echo e(url('dashboard/dashboardRoles')); ?>">
                    <i class="fas fa-lock"></i>
                    <span>Roles</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link<?php echo e(Request::is('dashboard/dashboardPosts') ? ' active' : ''); ?>" href="<?php echo e(url('dashboard/dashboardPosts')); ?>">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Posts</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link<?php echo e(Request::is('dashboard/dashboardCauses') ? ' active' : ''); ?>" href="<?php echo e(url('dashboard/dashboardCauses')); ?>">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Causes</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link<?php echo e(Request::is('dashboard/dashboardEvents') ? ' active' : ''); ?>" href="<?php echo e(url('dashboard/dashboardEvents')); ?>">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Events</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link<?php echo e(Request::is('dashboard/dashboardMessages') ? ' active' : ''); ?>" href="<?php echo e(url('dashboard/dashboardMessages')); ?>">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Messages</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link<?php echo e(Request::is('dashboard/dashboardCategores') ? ' active' : ''); ?>" href="<?php echo e(url('dashboard/dashboardCategores')); ?>">
                    <i class="fas fa-archive"></i>
                    <span>Categories</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link<?php echo e(Request::is('dashboard/dashboardMenus') ? ' active' : ''); ?>" href="<?php echo e(url('dashboard/dashboardMenus')); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link<?php echo e(Request::is('dashboard/dashboardSettings') ? ' active' : ''); ?>" href="<?php echo e(url('dashboard/dashboardSettings')); ?>">
      ...
      </html><?php /**PATH /var/www/Charity/resources/views/dashboard/layouts/main.blade.php ENDPATH**/ ?>