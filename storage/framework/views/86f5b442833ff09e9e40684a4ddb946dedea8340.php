          ...
          <div class="card card-small edit-user-details mb-4">
            <div class="card-header p-0">
              <div class="edit-user-details__bg">
                <img src="<?php echo e(asset('dashboardassets/images/content-management/3.jpg')); ?>" alt="Background Image">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Charity/resources/views/dashboard/dashboardMenus/index.blade.php ENDPATH**/ ?>