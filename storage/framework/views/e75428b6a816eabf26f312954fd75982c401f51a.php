    ...
    <div class="col-lg-9 col-md-12">
      <div class="card card-small mb-3">
        <div id="form-container" class="card-body">
          <!-- ================================================ Page dashboard Ads ========================================================= -->
          <form action="<?php echo e(route('dashboardAds.store')); ?>" method="POST"  role="form" enctype="multipart/form-data" class="add-new-post" id="FormID">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.postmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Charity/resources/views/dashboard/dashboardAds/create.blade.php ENDPATH**/ ?>