...
<section class="banner-area relative">
	...
	<div class="container">
		<div class="row align-items-center banner-content">
			<div class="col-lg-5">
				<h1 class="text-white">المشاركات لدينا </h1>
				<!-- =============================== Setting BASE ======================================== -->
				<p><?php echo Setting()->content_blog_ar; ?></p>
			</div>
		</div>
	</div>
</section>
					...
					<article class="blog_item">
						...
						<div class="blog_details">
							...
							<a class="d-inline-block" href="<?php echo url('Posts'); ?>/<?php echo $Post->slug; ?>">
								<h2><?php echo substr($Post->Title_ar, 0, 190); ?></h2>
							</a>
							<!-- =============================== Posts ======================================== -->
							<p><?php echo substr($Post->body_ar, 0, 190); ?></p>
							<ul class="blog-info-link">
								...
								<!-- =============================== Comments Posts ======================================== -->
					             ...
					             <li><a><i class="fa fa-comment-o"></i> <?php echo e(count($Post->Comments)); ?> تعليقات</a></li>
					             <?php else: ?>
              ...
              <div class="media post_item">
                ...
                <div class="media-body">
                  ...
                  <a href="<?php echo url('Posts'); ?>/<?php echo $RentPost->slug; ?>">
                    <h3><?php echo substr($RentPost->Title_ar, 0, 190); ?></h3>
                  </a>
...
<?php echo $__env->make('arabic.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Charity/resources/views/arabic/Posts/index.blade.php ENDPATH**/ ?>