...
<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
    ...
    <div class="nav-wrapper">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link{{ Request::is('dashboard/dashboardUsers') ? ' active' : '' }}" href="{{ url('dashboard/dashboardUsers') }}">
                    <i class="fas fa-user"></i>
                    <span>Users</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ Request::is('dashboard/dashboardRoles') ? ' active' : '' }}" href="{{ url('dashboard/dashboardRoles') }}">
                    <i class="fas fa-lock"></i>
                    <span>Roles</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ Request::is('dashboard/dashboardPosts') ? ' active' : '' }}" href="{{ url('dashboard/dashboardPosts') }}">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Posts</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ Request::is('dashboard/dashboardCauses') ? ' active' : '' }}" href="{{ url('dashboard/dashboardCauses') }}">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Causes</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ Request::is('dashboard/dashboardEvents') ? ' active' : '' }}" href="{{ url('dashboard/dashboardEvents') }}">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Events</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ Request::is('dashboard/dashboardMessages') ? ' active' : '' }}" href="{{ url('dashboard/dashboardMessages') }}">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Messages</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ Request::is('dashboard/dashboardCategores') ? ' active' : '' }}" href="{{ url('dashboard/dashboardCategores') }}">
                    <i class="fas fa-archive"></i>
                    <span>Categories</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link{{ Request::is('dashboard/dashboardMenus') ? ' active' : '' }}" href="{{ url('dashboard/dashboardMenus') }}">
            ...
            <li class="nav-item">
                <a class="nav-link{{ Request::is('dashboard/dashboardSettings') ? ' active' : '' }}" href="{{ url('dashboard/dashboardSettings') }}">
